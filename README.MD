...
|File|Features|
|-|-|
|[basic-use.ts](./src/examples/basic-use.ts)|Minimal "Hello World" example. Illustrates the use of the [CVODE](https://sundials.readthedocs.io/en/latest/cvode/index.html) method.|
