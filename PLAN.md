 ...
 * @example
 * // Example. Solve the following initial value problem using the <Method Name> method:
 * //   dx/dt = x + y - t
 * //   dy/dt = x * y + t
 * //   x(0) = 1
 * //   y(0) = -1
 * // on [0, 2] with the step 0.01.
 * import { ODEs, <methodName> } from 'diff-grok';
 *
 * const task: ODEs = {
 ...
 *
 * try {
 *   // Solve the problem using the <Method Name> method
 *   const solution = <methodName>(task);
 *
