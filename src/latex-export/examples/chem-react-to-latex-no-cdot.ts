/** Example: Chem react model → LaTeX with juxtaposition instead of \cdot. */
...
#argument: t
  initial = 0 {units: min; caption: Initial; category: Time; min: 0; max: 5}
  final = 6 {units: min; caption: Final; category: Time; min: 6; max: 10}
  step = 0.01 {units: min; caption: Step; category: Time; min: 0.01; max: 0.1; step: 0.001}

#tolerance: 5e-5`;

// Use juxtaposition (no \cdot) for multiplication
const latex = convertIvpToLatex(MODEL, {useCdot: false});
console.log(latex);
